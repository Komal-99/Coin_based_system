...
exports.errorHandler = exports.handlePrismaError = void 0;
...
function handlePrismaError(error, res) {
    if (error instanceof library_1.PrismaClientKnownRequestError) {
        var errorMessage = 'Internal server error: An unexpected error occurred. Please try again later.';
        switch (error.code) {
            case 'P2002':
...
//# sourceMappingURL=requests-handler.js.map